...
public class StudentHomeContentController {
    ...
    private static final String GRADES_FXML = "/com/sisjuan/fxml/StudentGradingModule.fxml";
    private static final String SCHEDULE_FXML = "/com/sisjuan/fxml/StudentClassSchedule.fxml";
    private static final String ENROLLMENT_FXML = "/com/sisjuan/fxml/StudentEnrollmentContent.fxml";
    private static final String PAYMENT_FXML = "/com/sisjuan/fxml/StudentPaymentInfo.fxml";
    ...
    public void initialize() {
        ...
        Task<HomeContentData> loadHomeDataTask = new Task<>() {
            ...
            protected HomeContentData call() throws Exception {
                ...
                int currentAcademicYearId = com.sisjuan.utilities.SchoolYearAndSemester.getCurrentAcademicYearId();
