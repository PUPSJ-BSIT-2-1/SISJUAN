...
public class StudentDashboardController {
    ...
    private static final String HOME_FXML = "/com/sisjuan/fxml/StudentHomeContent.fxml";
    ...
    private static final String PAYMENT_INFO_FXML = "/com/sisjuan/fxml/StudentPaymentInfo.fxml";
