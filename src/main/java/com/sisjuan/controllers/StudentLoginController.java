    ...
    public void backToFrontPage(MouseEvent event) {
        try {
            ...
            Stage newStage = StageAndSceneUtils.loadStage(
                    "/com/sisjuan/fxml/GeneralFrontPage.fxml",
                "SISJUAN - Welcome",
                null, // iconPath
                ...
                Platform.runLater(() -> {
                    ...
                    if (statusId != null) {
                        if (statusId == 2) { // Pending approval
                            ...
                            try {
                                u.loadStage(stage,"/com/sisjuan/fxml/StudentDashboard.fxml", StageAndSceneUtils.WindowSize.MEDIUM);
        ...
        loginExecutor.submit(() -> {
            try {
                ...
                Platform.runLater(() -> {
                    ...
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sisjuan/fxml/GeneralVerificationCode.fxml"));
