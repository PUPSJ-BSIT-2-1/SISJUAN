...
public class AdminHomeContentController {
    ...
    public void initialize() {
        ...
        String adminIdentifier = com.sisjuan.utilities.RememberMeHandler.getCurrentUserFacultyNumber();
    ...
    private String getAdminFullName(String identifier) {
        ...
        try (Connection conn = com.sisjuan.utilities.DBConnection.getConnection();
    ...
    private void handleSendAnnouncementButton() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/sisjuan/fxml/AdminAnnouncementDialog.fxml"));
