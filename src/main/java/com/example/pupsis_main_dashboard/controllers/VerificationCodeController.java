...
public class VerificationCodeController {
    ...
    private final EmailService emailService = new EmailService("harolddelapena.11@gmail.com", "sfhq xeks hgeo yfja");
    ...
    private void setupDigitField(TextField current, TextField next) {
        ...
        if (next != null) current.textProperty().addListener((o, old, val) -> {
