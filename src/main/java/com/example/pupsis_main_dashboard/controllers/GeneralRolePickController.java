...
public class GeneralRolePickController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GeneralRolePickController.class);
...
//        		transition2(button, stage, fxmlPath);
    ...
    private void applyInitialTheme() {
        ...
        boolean darkModeEnabled = settingsPrefs.getBoolean(GeneralSettingsController.THEME_PREF, false);
