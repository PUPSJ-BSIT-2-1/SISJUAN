...
import com.example.pupsis_main_dashboard.models.TransactionHistory;
...
public class AdminPaymentTransactionController {
    ...
    public static void showPaymentTransactionHistory() {
        try {
            FXMLLoader loader = new FXMLLoader(AdminPaymentTransactionController.class.getResource("/com/example/pupsis_main_dashboard/fxml/AdminPaymentTransaction.fxml"));
